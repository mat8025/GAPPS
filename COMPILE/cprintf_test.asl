...
//Use_= " Demo  of test cprintf  ";

//  script and func stem   e.g.  cprintf
...
int Uac::cprintf_test(Svarg * sarg)  
{
  Str ans = "?";
  cout << " cprintf test  " << ans << endl;
  RUN_ASL = 0;
...
//==============================//
 ...
 extern "C" int cprintf_test(Svarg * sarg)  {
...
//////////////////////////////////////////////////////////////////////////
  ...
  For a new script  - check it does not already exist in uac*.h
   ...
   xyz = your script stem name  e.g. cprintf_test for cprintf_test.asl script

   one time

  (1)  append '#include "xyz.asl"' to uac_apps.h 

  (2) append  ' int xyz (Svarg * sarg); ' uac_methods.h

  (3) append  ' "xyz", '  to uac_functions.h
