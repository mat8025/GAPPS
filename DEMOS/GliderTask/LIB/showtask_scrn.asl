...
<<"%V $mapwo \n"
  ...
  tpwo[3] =cWo(vp,@BV,@name,"_TP3_",@value,"xxx",@style,"SVR", @drawon,@color,BLUE_,@fonthue,BLACK_)

  tpwo[4] =cWo(vp,@BV,@name,"_TP4_",@value,"xxx",@style,"SVR", @drawon,@color,BLUE_,@fonthue,BLACK_)
