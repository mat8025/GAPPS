...
// calc_gl = cGl(calwo,_GLTXY,DFVEC,CALCON,_GLHUE,RED_,_GLSYMBOL,"triangle",_GLSYMHUE, BLUE_,GLEO);
  ...
  sGl(_GLID,fiber_gl,_GLXVEC,DVEC,_GLYVEC,FIBRCON,_GLHUE,BLUE_,_GLSYMBOL,DIAMOND_,_GLSYMHUE, PINK_);
...
// TRANS OK ?
  ...
  int wedgl[] = { ext_gl, calb_gl, se_gl, calc_gl, carb_gl, fiber_gl,fat_gl,prot_gl, cardio_gl, wt_gl, strength_gl,-1};
