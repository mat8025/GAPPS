...
//  add buttons to allow user to scroll through the test_cases
...
proc drawFPGraph()
{
  ...
  //grid(crwo)
    ...
    text(fpwo,comment, 0.2,0,5,0,0,"black")
...
//!!"cat test_case1.ip | asl fp_fcV8.asl > test_case.op"
