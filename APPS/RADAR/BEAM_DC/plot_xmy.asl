...
// setup scaling
  ...
  // create  separate vector for each Y column 
  vn = "YV$i"
  $vn = YV
  }
  ...
  // use the lefthand col as the x vector
...
//<<" CGW $aw \n"
  ...
  int hue[20] = { RED, GREEN, BLUE, BLACK, ORANGE, YELLOW, CYAN }
...
int ygl[nylines+1];  
  ...
  for (i = 0; i < nylines ; i++) {
   ...
   ygl[i]=CreateGline(@woid,grwo,@type,"XY",@xvec, XV, @yvec, $vn, @color, hue[i] ,@usescales,0)
