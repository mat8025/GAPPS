...
proc redraw()
{
  ...
  plotLine(sri_wo,0,ac_raz,256,ac_raz,"red")
  plotLine(sri_wo,0,ac_raz,256,tilt_top,"blue")
  plotLine(sri_wo,0,ac_raz,cloud_bin,cloud_top,"green")
...
///////////////////////////////////////////////////////////////////////////////
  ...
  // GraphWo
   ...
   lrdbz_wo=createGWOB(aw,@GRAPH,@resize,0.5,0.66,0.85,0.98,@name,"LRDBZ",@color,"white")
   setgwob(lrdbz_wo,@drawon,@pixmapon,@save,@clip,0.1,0.1,0.9,0.9,@scales,0,-5,185,120,@savescales,0)

   lri_wo=createGWOB(aw,@GRAPH,@resize,0.5,0.1,0.85,0.65,@name,"PY",@color,"white")
...
///////////////////////////////////  Glines  /////////////////////////////////////////////////////
   ...
   strmtop_gl = CreateGline(@wid,lrdbz_wo,@type,"XY",@yvec,Strm_t,@xvec,Strm_r,@@color,"green")
