...
//                                   q_cpt.cpp 
//		          
//    @comment  computes pitch track  -updated 
//    @release   CARBON  
//    @vers 1.2 He Helium                                                 
//    @date Sat Feb  4 14:36:32 2023    
//    @cdate 01/29/2000              
//    @author: Mark Terry                                  
...
//    - 
///////////////////////////////////<v_&_v>//////////////////////////////////*/ 
static char     gaspid[] = "q_cpt.cpp     @vers 1.2 He Helium  Sat Feb  4 14:36:32 2023 Mark Terry ";
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>//
#include <stdio.h>
#include <fcntl.h>
#include <math.h>
...
void q_stats(float the_pitch[], float *old_pp,float *rave_pp, int npm) 
{
...
int q_check_double(  float results[],  float *pitch0,float *pitch1,float *dp0,float *dp1,float rave_pp, int npm, float dt)
{
	int doubling = 0;
	float p0,p1;
...
void q_set_pitch(float results[],int k,	 int n_peaks,
		 float dt,float *new_pp,float *the_lag,float *the_amp)
{
...
int q_reject(  float new_pp,float ave_pp,float rave_pp,float the_amp, int npm)
{
	int a_reject =0;
