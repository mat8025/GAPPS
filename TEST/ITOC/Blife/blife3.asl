...
// SetGwindow(cw,"resize",0.1,0.31,0.9,0.49,0)
 ...
 setgw("clear","redraw","save")
  ...
  grwo=CreateGwob(cw,"GRAPH","resize",0,0.1,0.1,0.7,0.7,"scales",-60,1.0,xmax,1.8)
  SetGwob(grwo,"fonthue","black","name","graph","redraw")


  b1gl=CreateGline("wid",grwo,"type","XY","xvec",X,"yvec",B1,"color", "green","usescales",0)
  DrawGline(b1gl)

  b2gl=CreateGline("wid",grwo,"type","XY","xvec",X,"yvec",B2,"color", "blue","usescales",0)
  DrawGline(b2gl)

  b3gl=CreateGline("wid",grwo,"type","XY","xvec",X,"yvec",RV,"color", "red","usescales",0,"name","Rayovac")
  DrawGline(b3gl)

#{
  xlabel=CreateGwob(cw,"LABEL","resize",0,0.5,0.02,0.7,0.1)
  SetGwob(xlabel,"fonthue","black","name","xlabel","value","Time_(mins)","redraw")

  ylabel=CreateGwob(cw,"LABEL","resize",0,0,0.2,0.1,0.5)
  SetGwob(ylabel,"fonthue","black","name","ylabel","value","Volts","redraw")


  erlabel=CreateGwob(cw,"LABEL","resize",1,70,1.6,240,1.7)
  SetGwob(erlabel,"fonthue","green","value","EverReady","redraw")


  drlabel=CreateGwob(cw,"LABEL","resize",1,500,1.5,600,1.6)
  SetGwob(drlabel,"fonthue","blue","value","Duracell","redraw")


  rvlabel=CreateGwob(cw,"LABEL","resize",1,400,1.2,600,1.4)
