...
proc PlanView()
{
     ...
     Setgwob(pvwo,"hue","black","showpixmap","save")
...
//<<" %V$rx $rX \n"
     ...
     Setgwob(svwo,"hue","black","showpixmap","save")
}
...
#}
 ...
 //gwo=createGWOB(vp,"BV",@name,"B_V",@color,"green",@resize_fr,bx,by,bX,bY)

  vptxt=CreateGWOB(vp,"TEXT",@name,"TXT",@resize_fr,0.1,0.01,0.75,0.1,@color,"blue")

  setgwob(vptxt,@BORDER,@DRAWON,@CLIPBORDER,@FONTHUE,"black", "redraw","pixmapoff")

  vpwo=CreateGWOB(vp,"GRAPH",@name,"VP",@resize_fr,0.2,0.11,0.92,0.95,@color,"white")

  setgwob(vpwo,@scales,-20,-20,20,20, "save","redraw","drawoff","pixmapon")


  pvwo = CreateGWOB(vp,"GRAPH",@resize_fr,0.01,0.11,0.19,0.5,"name","PLANVIEW","color","white")

  setgwob(pvwo,@scales,-200,-200,200,200, "save","redraw","drawoff","pixmapon")



  svwo = CreateGWOB(vp,"GRAPH",@resize_fr,0.01,0.51,0.19,0.95,@name,"SIDEVIEW","color","white")
...
/////////////////////////////////////////////////// CONTROLS ////////////////////////////
 ...
 qwo=createGWOB(vp,"BV",@name,"QUIT?",@VALUE,"QUIT",@color,"orange",@resize_fr,bx,by,bX,bY)
 setgwob(qwo,@BORDER,@DRAW,@CLIPBORDER,@FONTHUE,"black", "redraw")

 azimwo=createGWOB(vp,"BV",@name,"AZIM",@VALUE,"1",@color,"white")
 setgwob(azimwo,@BORDER,@DRAW,@CLIPBORDER,@FONTHUE,"black",@style,"SVB")

 distwo=createGWOB(vp,"BV",@name,"DIST",@VALUE,"1",@color,"white")
 setgwob(distwo,@BORDER,@DRAW,@CLIPBORDER,@FONTHUE,"black",@style,"SVB")

 elevwo=createGWOB(vp,"BV",@name,"ELEV",@VALUE,"1",@color,"white")
 setgwob(elevwo,@BORDER,@DRAW,@CLIPBORDER,@FONTHUE,"black",@style,"SVB")
